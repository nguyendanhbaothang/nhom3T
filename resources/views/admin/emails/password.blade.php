        ...
        <table role="presentation" style="width:700px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
                      ...
                      <tr>
                        ...
                        <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="margin:0 0 -100px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><i>*Hãy dùng mật khẩu này để truy cập tài khoản của bạn.</i><br><br>
                            @if(isset($data['pass']))
                            <a href="#" style="color:#ee4c50;text-decoration:underline;"><b style="color: blue"><i>Mật khẩu mới: </i></b>{{ $data['pass'] }}<br></a>
                            @endif
                        </td>
                      </tr>
                    </table>
          ...
          <tr>
            ...
            <table>
                <tr>
                    <td colspan="2">
                        <i style="margin:0;font-size:16px;line-height:0px;font-family:Arial,sans-serif;"><br><a href="#" style="color:#ee4c50;text-decoration:underline;">Email: <a href="mailto:nguyendanhbaothang9a@gamil.com" style="color:rgb(17,85,204)"
